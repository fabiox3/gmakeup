...
// Returns the public 'AppBundle\Controller\ServiziController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Controller/ServiziController.php';

return $this->services['AppBundle\Controller\ServiziController'] = new \AppBundle\Controller\ServiziController();
